...
C = loadtxt("C_original.dat")
#C = loadtxt("C_feats_shuffled_within_clusters_intercluster_mean.dat")
#C = loadtxt("C_feats_shuffled_within_clusters_offblock_mean_inblock_mean.dat")
