...
i_pants_shirt = numpy.arange(12,15+1)
i_glass = 11
i_watch = 10
i_key = 9
i_apartment = 8
...
fig.savefig('C_clustered_shuffled_within.pdf', bbox_inches='tight')
fig.savefig('C_clustered_shuffled_within.png', bbox_inches='tight')
